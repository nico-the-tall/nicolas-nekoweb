      ...
      <div className={sx.content}>
        ...
        <ul>
          ...
          <li>
            ...
            Vorgaben der DSGVO verstößt. Zuständige Behörde für Berlin:{" "}
            <a
        ...
        <ul>
          ...
          <li>
            ...
            übermittelt. <strong>Rechtsgrundlagen:</strong> Berechtigte
        ...
        <p>
          ...
          ), um den Fortschritt von Achievements (Errungenschaften) zu
          speichern. Dabei werden ausschließlich Informationen darüber
          gespeichert, welche Achievements freigeschaltet wurden - keine
          personenbezogenen Daten, keine Identifikatoren und keine
          Nutzungsprofile.
        </p>
        <ul>
          <li>
          ...
          <li>
            ...
            Nutzers (localStorage). Die Daten werden nicht an Server
            übermittelt, nicht mit Dritten geteilt und verlassen das Gerät des
            Nutzers nicht.
          </li>
          <li>
            <strong>Zweck:</strong> Speicherung des Achievement-Fortschritts
            über Seitenbesuche hinweg. Achievements sind eine optionale,
            spielerische Funktion dieser Website und kein verpflichtender
          ...
          <li>
            ...
            über die Browsereinstellungen (Websitedaten löschen) entfernt
            werden.
          </li>
        </ul>
